...
-- ==========================================
-- Esto garantiza aislamiento de datos NIVEL BASE DE DATOS
...
-- Ejemplo de Política RLS: "Solo el personal de la empresa X puede ver datos de la empresa X"
CREATE POLICY empresa_isolation_policy ON dat_informes_seguridad
